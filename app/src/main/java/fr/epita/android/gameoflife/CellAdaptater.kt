...
class CellAdaptater(val context : Context, val data : MutableList<Cell>, private val onClickListener : (Int) -> View.OnClickListener) : RecyclerView.Adapter<CellAdaptater.ViewHolder>()  {
    ...
    override fun onBindViewHolder(p0: ViewHolder, p1: Int) {
        ...
        p0.cellView.setOnClickListener(onClickListener(p1))
    }
